...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Part.cost'
        db.delete_column(u'form_part', 'cost')
        ...
        # Adding field 'Part.batch_count'
        db.add_column(u'form_part', 'batch_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Type.cost_rate'
        db.add_column(u'form_type', 'cost_rate',
                      self.gf('django.db.models.fields.DecimalField')(default=0.00, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Adding field 'Type.cost_noi'
        db.add_column(u'form_type', 'cost_noi',
                      self.gf('django.db.models.fields.DecimalField')(default=0.000, max_digits=5, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Part.cost'
        db.add_column(u'form_part', 'cost',
                      self.gf('django.db.models.fields.DecimalField')(default='', max_digits=12, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Part.rush'
        db.delete_column(u'form_part', 'rush')

        # Deleting field 'Part.batch_count'
        db.delete_column(u'form_part', 'batch_count')

        # Deleting field 'Type.cost_rate'
        db.delete_column(u'form_type', 'cost_rate')

        # Deleting field 'Type.cost_noi'
        db.delete_column(u'form_type', 'cost_noi')
